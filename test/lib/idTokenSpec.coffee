...
describe 'ID Token', ->
  ...
  describe 'verify', ->
    ...
    describe 'with "iss" claim mismatch', ->
      ...
      before (done) ->
        ...
        IDToken.verify jwt, options, (error, idtoken) ->
          err   = error
          token = idtoken
          done()

      it 'should provide an error', ->
        expect(err).to.be.instanceof IDTokenError
    ...
    describe 'with "aud" claim  mismatch', ->
    ...
    describe 'with "azp" claim mismatch', ->
    ...
    describe 'with "alg" header mismatch', ->
    ...
    describe 'with invalid "iat" claim', ->

      it 'should provide an error'
      it 'should not provide a decoded token'


    describe 'with missing "nonce" claim', ->

      it 'should provide an error'
      it 'should not provide a decoded token'


    describe 'with "nonce" claim mismatch', ->

      it 'should provide an error'
      it 'should not provide a decoded token'


    describe 'with invalid "acr" claim', ->

      it 'should provide an error'
      it 'should not provide a decoded token'


    describe 'with invalid "max_age"', ->
    ...
    describe 'with valid token', ->
      ...
      it 'should not provide a decoded token', ->
        expect(token).to.be.instanceof IDToken
